...
export default function Navbar() {
    const handleSidebarRightToggle = event => {
        document.body.classList.toggle('sidebar-icon-only');
    };

    const handleSidebarLeftToggle = event => {
    ...
    return (
        <nav className="navbar p-0 fixed-top d-flex flex-row">
            ...
            <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                ...
                <button onClick={handleSidebarLeftToggle} className="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas">
