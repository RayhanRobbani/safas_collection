...
export default function Home() {
    return (
        <FrontendLayout>
            <Head title="Home" />
            <section id="hero" className="hero d-flex flex-column justify-content-center align-items-center" data-aos="fade" data-aos-delay="500">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-6 text-center">
                            ...
                            <Link href={route('contact')} className="btn-get-started">Contact Me</Link>
                        </div>
                    </div>
                </div>
            </section>
